...
const config: Config = {
  title: 'WebTrendsSDK Documentation',
  tagline: 'A .NET library for the WebTrends v2 API',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/IngeniumSE/WebTrendsSDK',
          label: 'GitHub',
          position: 'right',
        },
      ],
